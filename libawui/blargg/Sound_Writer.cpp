...
static aiff_header_t aiff_header = {
    {'F', 'O', 'R', 'M'}, {0}, {'A', 'I', 'F', 'F'}, {'C', 'O', 'M', 'M'}, {0, 0, 0, 22}, {0, 1}, {0}, {0, 16}, {0x40, 0x0f}, {0}, {0}, {'N', 'O', 'N', 'E'}, {'S', 'S', 'N', 'D'}, {0}, {0}};

static char aiff_trailer[] = {0, 0, 0, 0};

Sound_Writer::Sound_Writer(long rate, const char *filename_in) : file(fopen(filename_in, "wb")),
								 sample_count(0),
								 chan_count_(1)
{
